...
<table width="100%"  class="datatables-basic table table-bordered ">
  ...
  $sql->selectall("pro_stag where pro_id=$pro_id and name LIKE '$search%'  ORDER BY id DESC  limit 10 offset  $id");
...
<?php
        ...
        $sql->selectall("pro_stag  where pro_id=$pro_id and name LIKE '$search%' ");
   ...
   $n=ceil($num/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             $pp=$page-1;
             if($page!=1){
                  echo '<li class="page-item "><a class="page-link" href="?pro_stag=list&id='.$_POST['pro_id'].'&page='.$pp.'" tabindex="">Previous</a></li>';
                }else{
              ...
              if ($get<0) {
               $get=1;
                  ...
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?pro_stag=list&id='.$_POST['pro_id'].'&search='.$search.'&page='.$i.'">'.$i.'</a></li>';
                }
                          } 
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                echo '<a class="page-link" href="?pro_stag=list&id='.$_POST['pro_id'].'&page='.$page.'">Next</a>';
              }else{
                echo '<li class="page-item disabled">
...
<?php
  ...
  $sql->selectall("pro_stag  where pro_id=$pro_id  ORDER BY id DESC limit 10   offset  $id ");
...
<?php
       ...
       $sql->check('pro_stag',["pro_id"=>"$pro_id"]);
             ...
             if($page!=1){
              ...
              if ($get<0) {
               $get=1;
                  ...
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?pro_stag=list&id='.$_POST['pro_id'].'&page='.$i.'">'.$i.'</a></li>';
                }
                          } 
