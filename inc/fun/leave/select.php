...
<table width="100%"  class="datatables-basic table table-bordered ">
      <thead>
          ...
          <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['EMPLOYEE_ID'];?></center></th>
          <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['EMPLOYEE_NAME'];?></center> </th>
          <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['Departments'];?></center> </th>
          <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['From'];?></center> </th>
          <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['To'];?></center> </th>
...
<?php
     	  ...
     	  $sql->selectall("emp_leave  where   emp_id=$emp_id and emp_name LIKE '$search%' ");
