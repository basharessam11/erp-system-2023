...
<table width="100%"  class="datatables-basic table table-bordered ">
  ...
  $sql->selectall("salary where  name LIKE '$search%' and id!=10 ORDER BY id DESC  limit 10 offset  $id");
...
<?php
  ...
  $sql->selectall("salary where id!=10  ORDER BY id DESC limit 10   offset  $id ");
