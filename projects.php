...
<h5 class="card-title" style="float:left;"> <?=$lang['Projects_all']?> </h5>
...
if (isset($_GET['search'])) {
  ...
  $sql->selectall("project where  name LIKE '$search%'   limit 10 offset  $id");
  }else{
      ...
      $sql->check('project',["1"=>1]);
       $n=ceil($sql->check/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             if($page!=1){
              if (isset($_GET['search'])) {
                 echo '<li class="page-item "><a class="page-link" href="?projects=list&search='.$search.'&page='.$pp.'" tabindex="">Previous</a></li>';
              }else{
              ...
              for ($i=$_GET['page']; $i <$n ; $i++ ) { 
                  ...
                  if ($i<=$_GET['page']+5) {
                    ...
                    if (isset($_GET['search'])) {
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?projects=list&search='.$_GET['search'].'&page='.$i.'">'.$i.'</a></li>';
                    }else{
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?projects=list&page='.$i.'">'.$i.'</a></li>';
                    }
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                  if (isset($_GET['search'])) {
                    echo '<a class="page-link" href="?projects=list&search='.$_GET['search'].'&page='.$page.'">Next</a>';
                  }else{
         ...
         <script type="text/javascript" class="init">
           $(document).ready(function() {
             $("#myInput").on("keyup", function() {
               ...
               $.post('inc/fun/project/select.php', {
                 search: value
               }, function(data) {
                 $(".kk").html(data)
               });
         ...
         <script>
           ...
           $(document).ready(function() {
             $(".ar").attr("href", "inc/des/lang.php?lang=ar&page='projects=list'");
             $(".en").attr("href", "inc/des/lang.php?lang=en&page='projects=list'");
           });
         </script>
          }
           if (isset($_GET['img'])=='no') {
