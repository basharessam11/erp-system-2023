<?php
$id=$_GET['id'];
  $sql->selectall("salary2 where id=$id ");
...
<!-- DataTable with Buttons -->
 <br> 
   ...
   <div class="row">
                                ...
                                <form method="post" action="inc/fun/salary2/update.php">
...
<div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <label> <?php echo $lang['AMOUNT'];?></label>
                            ...
                            <input type="text" class="amount form-control" value="<?=$row['p_price']?>" >
                 ...
                 <div class="col-md-4">
                  ...
                  <label> <?php echo $lang['installment_amount'];?></label>
                            ...
                            <input type="text" value="<?=$row['price']?>" class="price_a form-control" name="price_a">
                ...
                <div class="col-md-2">
                  ...
                  <label><?php echo $lang['number_of_installments'];?>
                            ...
                            <input type="text" disabled="" value="<?=$row['p_price']/$row['price']?>" class="num form-control" >
                            <input type="hidden" value="<?=$row['p_price']/$row['price']?>" class="num form-control" name="num">
                            <input type="hidden" value="<?=$row['id']?>" class=" form-control" name="id">
                            <input type="hidden" value="<?=$row['trans_id']?>" class=" form-control" name="trans_id">
                            <input type="hidden" value="<?=$row['amount']?>" class=" form-control" name="amount">
...
<?php echo $lang['Installment_start_date'];?></label>
                            ...
                            <input type="date" value="<?=$row['date_start']?>" class="form-control" name="date_start">
                  ...
                  <label><?php echo $lang['Account_Name'];?></label>
                             ...
                             <select class="form-select js-example-basic-single" name="account_no">
                              <?php
                                   ...
                                   $sql->select1("account_no"," where account_c3=11 or account_c3=12");
                                   while ($row1=$sql->res1->fetch_assoc()) {
                                     echo'<option value="'.$row1['id'].'">'.$row1['account_name'].'</option>';
                                   }
