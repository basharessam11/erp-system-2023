           ...
           <div class="row g-4 mb-4">
             ...
             <div class="card">
               <div class="card-header border-bottom">
                 <h5 class="card-title" style="float:left;"><?=$lang['manger_accounting']?></h5>
 ...
 $date=date_create($row['date2']);
                       ...
                       <td style="padding: .625rem 0.25rem;">
                         <center>
                           ...
                           <a href="inc/fun/gl/app.php?id=<?=$row['id'];?>&a=1">
                             <button type="button" class="id btn btn-success">
    ...
    if (isset($_GET['search'])) {
      ...
      $sql->check('trans',["t_type"=>1,"total <"=>50000]);
       $n=ceil($sql->check/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             if($page!=1){
              if (isset($_GET['search'])) {
                 echo '<li class="page-item "><a class="page-link" href="?manger1=list&search='.$search.'&page='.$pp.'" tabindex="">Previous</a></li>';
              }else{
              ...
              for ($i=$_GET['page']; $i <$n ; $i++ ) { 
                  ...
                  if ($i<=$_GET['page']+5) {
                    ...
                    if (isset($_GET['search'])) {
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?manger1=list&search='.$_GET['search'].'&page='.$i.'">'.$i.'</a></li>';
                    }else{
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?manger1=list&page='.$i.'">'.$i.'</a></li>';
                    }
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                  if (isset($_GET['search'])) {
                    echo '<a class="page-link" href="?manger1=list&search='.$_GET['search'].'&page='.$page.'">Next</a>';
                  }else{
         ...
         <script type="text/javascript" class="init">
           $(document).ready(function() {
             $("#myInput").on("keyup", function() {
               ...
               $.post('inc/fun/expenses/select11.php', {
                 search: value
               }, function(data) {
                 $(".kk").html(data)
               });
         ...
         <script type="text/javascript">
           ...
           $(document).ready(function() {
             $(".ar").attr("href", "inc/des/lang.php?lang=ar&page='manger1=list'");
             $(".en").attr("href", "inc/des/lang.php?lang=en&page='manger1=list'");
           });
         </script>