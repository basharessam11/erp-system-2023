           ...
           <div class="row g-4 mb-4">
             ...
             <div class="card">
               <div class="card-header border-bottom">
                 <h5 class="card-title" style="float:left;"><?=$lang['Currencies']?> </h5>
                 ...
                 <table width="10%" class="datatables-basic  table table-bordered">
                   <thead>
                     <tr>
                       ...
                       <th style="padding: .625rem 0.25rem;">
                         <center><?=$lang['Currency_Code']?> </center>
                       </th>
                       <th style="padding: .625rem 0.25rem;">
                         <center><?=$lang['Base_Conversion_Rate']?></center>
                       </th>
                       <th style="padding: .625rem 0.25rem;">
...
if (isset($_GET['search'])) {
  ...
  $sql->selectall("currencies where  code LIKE '$search%'   limit 10 offset  $id");
  }else{
  ...
  for ($i=1; $i <=$page ; $i++) { 
   $id=$id+10;
    ...
    $sql->selectall("currencies ORDER BY code limit 10 offset  $id ");
  }
                     ...
                     <tr>
                       ...
                       <td style="padding: .625rem 0.25rem;">
                         <center>
                           ...
                           <button type="button" class="id btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal" name="<?=$row["code"]?>" rate="<?=$row["rate"]?>" besho="<?=$row["id"]?>">
    ...
    if (isset($_GET['search'])) {
              $search=$_GET['search'];
              $sql->selectall("Currencies  where  name LIKE '$search%' ");
              $num=$sql->res->num_rows;
              $n=ceil($num/10+1);
    }else{
      $sql->check('Currencies',["1"=>1]);
       $n=ceil($sql->check/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             if($page!=1){
              if (isset($_GET['search'])) {
                 echo '<li class="page-item "><a class="page-link" href="?Currencies=list&search='.$search.'&page='.$pp.'" tabindex="">Previous</a></li>';
              }else{
                 echo '<li class="page-item "><a class="page-link" href="?Currencies=list&page='.$pp.'" tabindex="">Previous</a></li>';
              }
              ...
              if ($get<0) {
               $get=1;
                    ...
                    if ($_GET['page']==$i) {
                     ...
                     if (isset($_GET['search'])) {
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?Currencies=list&search='.$search.'&page='.$i.'">'.$i.'</a></li>';
              }else{
                echo'<li class="page-item '.$a.'"><a class="page-link" href="?Currencies=list&page='.$i.'">'.$i.'</a></li>';              }
              ...
              for ($i=$_GET['page']; $i <$n ; $i++ ) { 
                  ...
                  if ($i<=$_GET['page']+5) {
                    ...
                    if (isset($_GET['search'])) {
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?Currencies=list&search='.$_GET['search'].'&page='.$i.'">'.$i.'</a></li>';
                    }else{
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?Currencies=list&page='.$i.'">'.$i.'</a></li>';
                    }
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                  if (isset($_GET['search'])) {
                    echo '<a class="page-link" href="?Currencies=list&search='.$_GET['search'].'&page='.$page.'">Next</a>';
                  }else{
                    echo '<a class="page-link" href="?Currencies=list&page='.$page.'">Next</a>';
                  }
         ...
         <script type="text/javascript" class="init">
           $(document).ready(function() {
             $("#myInput").on("keyup", function() {
               ...
               $.post('inc/fun/Currencies/select.php', {
                 search: value
               }, function(data) {
                 $(".kk").html(data)
               });
           ...
           <div class="modal-dialog" style="max-width: 70rem" role="document">
             <div class="modal-content">
               <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabel1"> <?=$lang['Currencies']?></h5>
                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
               </div>
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/Currencies/update.php" enctype="multipart/form-data">

                     <div class="col mb-3">
                       <label for="nameBasic" class="form-label"><?=$lang['Code']?></label>
                       <input type="text" id="nameBasic" class="name form-control" name="name" required="" placeholder="<?=$lang['Code']?>">
                     ...
                     <div class="col mb-3">
                       ...
                       <input type="text" id="nameBasic" multiple="" class="rate form-control" name="rate" placeholder="<?=$lang['Rate']?>">
         ...
         <div class="modal fade" id="basicModal1" tabindex="-1" aria-hidden="true">
           <div class="modal-dialog" style="max-width: 70rem" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/Currencies/insert.php" enctype="multipart/form-data">
                     <div class="col mb-3">
                       <label for="nameBasic" class="form-label"><?=$lang['Code']?></label>
         ...
         <div class="modal fade" id="basicModal2" tabindex="-1" aria-hidden="true">
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/Currencies/delete.php">
         ...
         <script>
           ...
           $(document).ready(function() {
             $(".ar").attr("href", "inc/des/lang.php?lang=ar&page='Currencies=list'");
             $(".en").attr("href", "inc/des/lang.php?lang=en&page='Currencies=list'");
           });
         </script>