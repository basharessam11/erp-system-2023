  ...
  <div class="table-responsive">
    <table class="table border-top m-0">
      <thead>
        ...
        <tr bgcolor="#e5e5e5" >
        <th colspan="3"><center><?php echo $lang['Payments'];?></center> </th>
        ...
        <th  style="width: 15%"><center>#</center> </th>
              ...
              <th style="width: 50%"><center><?php echo $lang['Payments_Types'];?> </center> </th>
              <th style="width: 35%"><center><?php echo $lang['Amount'];?></center> </th>
...
$m=date("m");
$y=date("Y");
 $sql->select2("salary_slip2","where emp_id=$id and year(date)='$y' and month(date)='$m' and type=1");
$x=0;
...
$sr=$row2['salary_id'];
 ...
 echo $row1['name'];
                              ...
                              ?></center></td>
              <td ><center><?=$row2['amount']?></center></td>
...
?>
             ...
             <tr bgcolor="#e5e5e5"  ><td colspan="1"></td>
    <td ><center>Total :</center></td>
     <td><center><?php 
 
 $sql->selectsum("amount",'salary_slip2',"emp_id=$id and year(date)='$y' and month(date)='$m' and type=1");
...
<table class="table border-top m-0">
      <thead>
        <tr bgcolor="#e5e5e5" >
        <th colspan="3"><center><?php echo $lang['Deductions'];?></center> </th>
        ...
        <th  style="width: 15%"><center>#</center> </th>
              ...
              <th style="width: 50%"><center><?php echo $lang['Deductions_Types'];?> </center> </th>
              <th style="width: 35%"><center><?php echo $lang['Amount'];?></center> </th>
      ...
      <tbody>
                                  ...
                                  // error_reporting(0);
$id=$_GET['id'];
 $sql->select2("salary_slip2","where emp_id=$id and year(date)='$y' and month(date)='$m' and type=2");
$x=0;
...
?>
    ...
    <td ><center><?php echo $lang['Total_Dedution'];?> :</center></td>
     <td><center><?php 
 
 $sql->selectsum("amount",'salary_slip2',"emp_id=$id and year(date)='$y' and month(date)='$m' and type=2");
 while ($row=$sql->res_sum->fetch_assoc()) {
  echo$amount=$row['SUM(amount)'];
 }
  ?></center></td>
...
<table class="table border-top m-0">
      <thead>
        <tr bgcolor="#e5e5e5" >
        <th colspan="3"><center>الاجمالي</center> </th>
        ...
        <th  style="width: 15%"><center>#</center> </th>
              ...
              <th style="width: 50%"><center>البند </center> </th>
              <th style="width: 35%"><center>القيمة</center> </th>
 ...
 while ($row=$sql->res_sum->fetch_assoc()) {
  ...
  ?></center></td>
   ...
   <tr >
    <td colspan="1"></td>
    <td ><center>غير المستحق:</center></td>
     <td><center><?php 
