...
<table width="100%"  class="datatables-basic table table-bordered ">
  ...
  $sql->selectall("trans where t_type=3 and name LIKE '%$search%'  ORDER BY id DESC limit 10 offset  $id");
...
<?php
        ...
        $sql->selectall("trans  where  t_type=3 and name LIKE '%$search%' ");
...
<?php
  ...
  <table width="100%"  class="datatables-basic table table-bordered ">
   ...
   <tbody id="myTable">
          ...
          $sql->selectall("trans where t_type=3 ORDER BY id DESC limit 10 offset  $id ");
