...
$id=$_GET['id'];
$sql->selectall("project where id=$id ");
...
?> <div class="container-xxl flex-grow-1 container-p-y">
                <div class="row g-4 mb-4">
                  ...
                  <div class="card">
                    ...
                    <div class="row">
                      <form method="post" action="inc/fun/project/update.php" enctype="multipart/form-data">
                        <div class="form-group">
                          <div class="row">

                            <div class="col-md-4">
                              <label><?php echo $lang['NAME'];?></label> <br>
                              <input type="text" name="name" value="<?=$row["name"]?>" class="form-control" placeholder="<?php echo $lang['NAME'];?>">
                            </div>

                            <div class="col-md-4">
                              <label><?=$lang['Start_Date']?> </label> <br>
                              <input type="date" value="<?=$row["start_date"]?>" class="form-control" name="start_date">
                            </div>

                            <div class="col-md-4">
                              <label><?=$lang['end_Date']?></label> <br>
                              ...
                              <select data-placeholder="<?=$lang['category']?>" class="form-select" tabindex="2" name="pro_cat">
                                <?php
                                       ...
                                       while($row1=$sql->res1->fetch_assoc())
                                        {
                                       ?>
                                <option value="<?=$id_cat=$row1['id']?>" <?php
if ($id_cat== $row["cat_id"]) {
 echo 'selected';
}
...
?>><?=$row1['name']?></option>
                            ...
                            <div class="col-md-4"><br>
                              ...
                              <select class="user form-select" tabindex="2" name="user">
                                <?php

                                       $sql->select1("user","order by name");
                                       while($row1=$sql->res1->fetch_assoc())
                                        {
                                       ?>
                                <option value="<?=$id_user=$row1['id']?>" <?php
...
?>><?=$row1['name']?></option>
                            ...
                            <div class="col-md-12"><br>
                              ...
                              <textarea name="des" class="form-control"><?=$row["des"]?></textarea>
                            </div>
  ...
  <?php
               ...
               ?>required="" class="form-control" placeholder="<?php echo $lang['NAME'];?>">
</div>
