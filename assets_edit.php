  <?php
$id=$_GET['id'];
    $sql->selectall("assets  where id=$id ");
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" name="name" value="<?=$row['name']?>" required="" class="form-control" placeholder="<?php echo $lang['NAME'];?>">
                  <br>
                </div>

                <div class="col-md-4">
                  <label><?php echo $lang['Date_purchased'];?> </label> <br>
                  <input type="date" class="form-control" value="<?=$row['sale_date']?>" required="" name="sale_date">
                </div>
                <div class="col-md-4">
                  <label><?php echo $lang['Service_start_date'];?> </label> <br>
                  <input type="date" class="form-control" value="<?=$row['start_date']?>" required="" name="start_date">
                </div>
...
if ($row1['id']== $row['branch']) {
                ...
                <div class="col-md-4">
                  ...
                  <select class="form-select " required="" name="account_c3">
                    ...
                    <?php
                                   ...
                                   while ($row1=$sql->res->fetch_assoc()) {
                                   if ($row1['id']== $row['account_c3']) {
                                    $sel='selected';
                                    }else{
                                      $sel='';
                                    }
                                     echo'<option '.$sel.' value="'.$row1['id'].'">'.$row1['name'].'</option>';
                                    }
                ...
                <div class="col-md-4"><br>
                  ...
                  <input type="text" name="exp" value="<?=$row['exp']?>" required="" class="form-control" placeholder="<?php echo $lang['production_age'];?>">
                </div>

                <div class="col-md-12"><br>
                  <label><?php echo $lang['Description'];?></label> <br>
                  <textarea name="des" class="form-control"><?=$row['des']?></textarea><br>
                </div>
                ...
                <div class="col-md-4"><br>
                  ...
                  <input type="text" name="price" required="" value="<?=$row['price']?>" class="form-control" placeholder="<?php echo $lang['Amount'];?>">
                </div>
                <div class="col-md-4">
                  <br>
                  ...
                  <select class="form-select " required="" name="currency">
                    ...
                    <?php
                                   ...
                                   while ($row1=$sql->res->fetch_assoc()) {
                                    ...
                                    if ($row1['id']== $row['currency']) {
                                    $sel='selected';
                                    }else{
                                      $sel='';
                                    }
                                     echo'<option '.$sel.' value="'.$row1['id'].'">'.$row1['code'].'</option>';
                                    }
                ...
                <div class="col-md-4">
                  ...
                  <select class="form-select " required="" name="account_no">
                    ...
                    <?php
                                   ...
                                   while ($row1=$sql->res->fetch_assoc()) {
                                      if ($row1['id']== $row['account_no']) {
                                    $sel='selected';
                                    }else{
                                      $sel='';
                                    }
                                     echo'<option '.$sel.' value="'.$row1['id'].'">'.$row1['account_name'].'</option>';
                                    }
