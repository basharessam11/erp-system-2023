...
if (empty($_GET)) {
 ...
 <!-- Customers -->
    <li class="menu-item <?php
if ($_GET['customers']=="list" or $_GET['group']=="list" or $_GET['Contact']=="list") {
echo "active open";
}
?>">
...
if ($_GET['suppliers']=="list") {
 ...
 ?>">
    ...
    <li class="menu-item <?php
if ($_GET['tax']=="list" or $_GET['dep']=="list" or $_GET['exp']=="list"or $_GET['trans']=="list"or $_GET['bills']=="list" or $_GET['trans1']=="list" or $_GET['acco']=="list" or $_GET['assets']=="list") {
echo "active open";
}
?>">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item dropdown-language dropdown me-2 me-xl-0">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
                <a class="dropdown-item" href="inc/des/lang?lang=en" >
                  <i class="flag-icon flag-icon-us flag-icon-squared rounded-circle fs-4 me-1"></i>
                  <span class="align-middle">English</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="inc/des/lang?lang=ar" data-language="fr">
