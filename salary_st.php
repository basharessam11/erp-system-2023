           ...
           <div class="row g-4 mb-4">
             ...
             <div class="card">
               <div class="row ">
                 ...
                 <div class="card-header border-bottom col-sm-12 col-md-6">
                 ...
                 <div class="card-header border-bottom col-sm-12 col-md-6">
                   ...
                   <a href="inc/fun/salary_st/add_salary.php" style="float: right;"> <button type="button" class=" btn btn-success" data-bs-toggle="modal" data-bs-target="#basicModal1">
                       اضافة رواتب هذا الشهر
                     </button></a>
 ...
 <center>  ﺗﻢ اﻻﺿﺎﻓﺔ ﺑﻨﺠﺎﺡ</center>
           ...
           if (isset($_GET['add12'])=='error') {
          echo '<br><br><div id="success-alert1" class="alert alert-danger" role="alert">
 <center> تم اضافة رواتب هذا الشهر من قبل</center>
</div>';
          } 
          if (isset($_GET['add22'])=='su') {
          echo '<br><br><div id="success-alert1" class="alert alert-success" role="alert">
 <center>  تم اضافة الرواتب بنجاح</center>
</div>';
          }
               ...
               <div class="row">
                 ...
                 <div class="col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end">
                   <div id="DataTables_Table_1_filter" class="dataTables_filter">
                     <br>
                     <a href="?salary_st=add"> <button type="button" class=" btn btn-success" data-bs-toggle="modal" data-bs-target="#basicModal1">
                         <?php echo $lang['Add'];?>
                       </button></a>
                     <br><br>
                 ...
                 <table width="10%" class="datatables-basic  table table-bordered">
                   <thead>
                     <tr>
                       ...
                       <th style="padding: .625rem 0.25rem;">
                         <center><?php echo $lang['Total'];?></center>
                       </th>
...
if (isset($_GET['search'])) {
  ...
  for ($i=1; $i <=$page ; $i++) { 
   $id=$id+10;
    ...
    $sql->selectall("emp_profile ORDER BY id limit 10 offset  $id ");
  }
      ...
      ?>
                     <tr>
                       ...
                       <td style="padding: .625rem 0.25rem;">
                         <center><?php
$user_id=$row['id'];
 $sql->selectsum("amount",'salary1',"emp_id=$user_id");

     while ($row1 = $sql->res_sum->fetch_assoc()) {
...
?></center>
                       ...
                       <td style="padding: .625rem 0.25rem;">
                         <center>
                           <a href="?salary_st=edit&id=<?=$row['id']?>">
      ...
      $sql->check('emp_profile',["1"=>1]);
       $n=ceil($sql->check/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             if($page!=1){
              if (isset($_GET['search'])) {
                 echo '<li class="page-item "><a class="page-link" href="?salary_st=list&search='.$search.'&page='.$pp.'" tabindex="">Previous</a></li>';
              }else{
                 echo '<li class="page-item "><a class="page-link" href="?salary_st=list&page='.$pp.'" tabindex="">Previous</a></li>';
              }
              ...
              if ($get<0) {
               $get=1;
                    ...
                    if ($_GET['page']==$i) {
                     ...
                     if (isset($_GET['search'])) {
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary_st=list&search='.$search.'&page='.$i.'">'.$i.'</a></li>';
              }else{
                echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary_st=list&page='.$i.'">'.$i.'</a></li>';              }
              ...
              for ($i=$_GET['page']; $i <$n ; $i++ ) { 
                  ...
                  if ($i<=$_GET['page']+5) {
                    ...
                    if (isset($_GET['search'])) {
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary_st=list&search='.$_GET['search'].'&page='.$i.'">'.$i.'</a></li>';
                    }else{
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary_st=list&page='.$i.'">'.$i.'</a></li>';
                    }
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                  if (isset($_GET['search'])) {
                    echo '<a class="page-link" href="?salary_st=list&search='.$_GET['search'].'&page='.$page.'">Next</a>';
                  }else{
                    echo '<a class="page-link" href="?salary_st=list&page='.$page.'">Next</a>';
                  }
         ...
         <script type="text/javascript" class="init">
           $(document).ready(function() {
             $("#myInput").on("keyup", function() {
               ...
               $.post('inc/fun/salary_st/select.php', {
                 search: value
               }, function(data) {
                 $(".kk").html(data)
               });
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/salary_st/delete.php">
         ...
         <script>
           ...
           $(document).ready(function() {
             $(".ar").attr("href", "inc/des/lang.php?lang=ar&page='salary_st=list'");
             $(".en").attr("href", "inc/des/lang.php?lang=en&page='salary_st=list'");
           });
         </script>