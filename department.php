           ...
           <div class="row g-4 mb-4">
             ...
             <div class="card">
               <div class="card-header border-bottom">
                 <h5 class="card-title" style="float:left;"><?php echo $lang['Departments'];?></h5>
...
if (isset($_GET['search'])) {
  ...
  $sql->selectall("department where  name LIKE '$search%'   limit 10 offset  $id");
  }else{
  ...
  for ($i=1; $i <=$page ; $i++) { 
   $id=$id+10;
    ...
    $sql->selectall("department ORDER BY name limit 10 offset  $id ");
  }
      ...
      $sql->check('department',["1"=>1]);
       $n=ceil($sql->check/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             if($page!=1){
              if (isset($_GET['search'])) {
                 echo '<li class="page-item "><a class="page-link" href="?department=list&search='.$search.'&page='.$pp.'" tabindex="">Previous</a></li>';
              }else{
              ...
              for ($i=$_GET['page']; $i <$n ; $i++ ) { 
                  ...
                  if ($i<=$_GET['page']+5) {
                    ...
                    if (isset($_GET['search'])) {
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?department=list&search='.$_GET['search'].'&page='.$i.'">'.$i.'</a></li>';
                    }else{
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?department=list&page='.$i.'">'.$i.'</a></li>';
                    }
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                  if (isset($_GET['search'])) {
                    echo '<a class="page-link" href="?department=list&search='.$_GET['search'].'&page='.$page.'">Next</a>';
                  }else{
         ...
         <script type="text/javascript" class="init">
           $(document).ready(function() {
             $("#myInput").on("keyup", function() {
               ...
               $.post('inc/fun/department/select.php', {
                 search: value
               }, function(data) {
                 $(".kk").html(data)
               });
           ...
           <div class="modal-dialog" style="max-width: 70rem" role="document">
             <div class="modal-content">
               <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabel1"><?php echo $lang['Departments'];?></h5>
                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
               </div>
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/department/update.php" enctype="multipart/form-data">
                     <div class="form-group">
                       <div class="row">
                         <div class="col-md-6">
                           <br>
                           <label><?=$lang['NAME']?></label>
                           <input type="text" class="name form-control" id="name" name="name" placeholder="<?php echo $lang['Name'];?>">
                         ...
                         <div class="col-md-6">
                           ...
                           <select class="user form-select" name="user">
                             <?php
                                   $sql->selectall("user");
                                   while ($row=$sql->res->fetch_assoc()) {
         ...
         <div class="modal fade" id="basicModal1" tabindex="-1" aria-hidden="true">
           <div class="modal-dialog" style="max-width: 70rem" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/department/insert.php" enctype="multipart/form-data">
                     <div class="form-group">
                       <div class="row">
                         <div class="col-md-12">
                           <br>
         ...
         <div class="modal fade" id="basicModal2" tabindex="-1" aria-hidden="true">
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/department/delete.php">
         ...
         <script>
           ...
           $(document).ready(function() {
             $(".ar").attr("href", "inc/des/lang.php?lang=ar&page='department=list'");
             $(".en").attr("href", "inc/des/lang.php?lang=en&page='department=list'");
           });
         </script>