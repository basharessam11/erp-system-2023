...
<table width="100%"  class="datatables-basic table table-bordered ">
 ...
 <tr>
  ...
  $sql->selectall("account_no where  account_name LIKE '$search%'  ORDER BY id DESC  limit 10 offset  $id");
...
$c3=$row['account_c3'];
    ...
    <td style="padding: .625rem 0.25rem;"><center ><?=$row["balance"]?></center></td>
...
<?php
     	  ...
     	  $sql->selectall("account_no  where  account_name LIKE '$search%' ");
...
<?php
 ...
 <tr>
  ...
  $sql->selectall("account_no  ORDER BY id DESC limit 10   offset  $id ");
