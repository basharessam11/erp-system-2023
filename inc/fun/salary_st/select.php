...
<table width="100%"  class="datatables-basic table table-bordered ">
      <thead>
        <tr>
         ...
         <th style="padding: .625rem 0.25rem;"><center>total</center> </th>
  ...
  $sql->selectall("emp_profile  where  name LIKE '$search%'  ORDER BY id   limit 10 offset  $id");
...
<?php
	 ...
	 $n=ceil($num/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             $pp=$page-1;
             if($page!=1){
                  echo '<li class="page-item "><a class="page-link" href="?salary1=list&page='.$pp.'" tabindex="">Previous</a></li>';
                }else{
              ...
              if ($get<0) {
               $get=1;
                  ...
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary1=list&search='.$search.'&page='.$i.'">'.$i.'</a></li>';
                }
                          } 
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                echo '<a class="page-link" href="?salary1=list&page='.$page.'">Next</a>';
              }else{
                echo '<li class="page-item disabled">
             ...
             if($page!=1){
              ...
              if ($get<0) {
               $get=1;
                  ...
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary1=list&page='.$i.'">'.$i.'</a></li>';
                }
                          } 
