...
<table width="100%"  class="datatables-basic table table-bordered ">
      <thead>
        <tr>
         ...
         <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['Account_Name'];?></center> </th>
    
         <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['BALANCE'];?></center> </th>
         <th style="padding: .625rem 0.25rem;"><center>تاريخ الشراء</center> </th>
  ...
  $sql->selectall("assets where name LIKE '$search%'  ORDER BY id DESC  limit 10 offset  $id");
 ...
 <tr >
      ...
      <td style="padding: .625rem 0.25rem;"><center ><?=$row["price"]?></center></td>
      <td style="padding: .625rem 0.25rem;"><center ><?=$row["sale_date"]?></center></td>
...
<?php
  ...
  $sql->selectall("assets  ORDER BY id DESC limit 10   offset  $id ");
