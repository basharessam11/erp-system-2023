...
<table width="100%"  class="datatables-basic table table-bordered ">
      <thead>
        ...
        <th style="padding: .625rem 0.25rem;"><center>الاستحقاق</center> </th>
...
?></center></td>
 <td style="padding: .625rem 0.25rem;"><center > <?=$row['date'];?></center></td>
...
<?php
  ...
  $sql->selectall("salary_slip where  from1=2   ORDER BY id  limit 10   offset  $id ");
