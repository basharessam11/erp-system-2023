...
<table width="100%"  class="datatables-basic table table-bordered ">
      <thead>
        <tr>
          ...
          <th style="padding: .625rem 0.25rem;"><center><?=$lang['NAME']?></center></center> </th>
           
         <th style="padding: .625rem 0.25rem;"><center><center><?=$lang['EDIT']?></center> </th>
        </tr>
  ...
  $sql->selectall("pro_cat where  name LIKE '$search%'  ORDER BY id DESC  limit 10 offset  $id");
...
<?php
  ...
  $sql->selectall("pro_cat  ORDER BY id DESC limit 10   offset  $id ");
