           ...
           <div class="row g-4 mb-4">
             ...
             <div class="card">
               <div class="card-header border-bottom">
                 <h5 class="card-title" style="float:left;"><?=$lang['manger_o']?></h5>
...
if (isset($_GET['search'])) {
  ...
  $sql->selectall("trans where   stat =0 and name LIKE '%$search%' and total >50000  ORDER BY id DESC limit 10 offset  $id");
  }else{
  ...
  for ($i=1; $i <=$page ; $i++) { 
   $id=$id+10;
    ...
    $sql->selectall("trans where  stat =0 and total>50000 ORDER BY id DESC limit 10 offset  $id ");
  }
 ...
 $date=date_create($row['date2']);
                       ...
                       <td style="padding: .625rem 0.25rem;">
                         <center>
                           ...
                           <a href="inc/fun/gl/app.php?id=<?=$row['id'];?>&a=2">
                             <button type="button" class="id btn btn-success">
    ...
    if (isset($_GET['search'])) {
              $search=$_GET['search'];
              $sql->selectall("trans  where t_type=1 name LIKE '$search%' and total >50000 ");
              $num=$sql->res->num_rows;
              $n=ceil($num/10+1);
    }else{
      $sql->selectall("trans  where t_type=1 and total >50000 ");
              $num=$sql->res->num_rows;
              $n=ceil($num/10+1);
    }
            ...
            $page=$_GET['page']=1;
             ...
             if($page!=1){
              if (isset($_GET['search'])) {
                 echo '<li class="page-item "><a class="page-link" href="?manger2=list&search='.$search.'&page='.$pp.'" tabindex="">Previous</a></li>';
              }else{
                 echo '<li class="page-item "><a class="page-link" href="?manger2=list&page='.$pp.'" tabindex="">Previous</a></li>';
              }
              ...
              if ($get<0) {
               $get=1;
                    ...
                    if ($_GET['page']==$i) {
                     ...
                     if (isset($_GET['search'])) {
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?manger2=list&search='.$search.'&page='.$i.'">'.$i.'</a></li>';
              }else{
                echo'<li class="page-item '.$a.'"><a class="page-link" href="?manger2=list&page='.$i.'">'.$i.'</a></li>';              }
              ...
              for ($i=$_GET['page']; $i <$n ; $i++ ) { 
                  ...
                  if ($i<=$_GET['page']+5) {
                    ...
                    if (isset($_GET['search'])) {
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?manger2=list&search='.$_GET['search'].'&page='.$i.'">'.$i.'</a></li>';
                    }else{
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?manger2=list&page='.$i.'">'.$i.'</a></li>';
                    }
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                  if (isset($_GET['search'])) {
                    echo '<a class="page-link" href="?manger2=list&search='.$_GET['search'].'&page='.$page.'">Next</a>';
                  }else{
                    echo '<a class="page-link" href="?manger2=list&page='.$page.'">Next</a>';
                  }
         ...
         <script type="text/javascript" class="init">
           $(document).ready(function() {
             $("#myInput").on("keyup", function() {
               ...
               $.post('inc/fun/expenses/select22.php', {
                 search: value
               }, function(data) {
                 $(".kk").html(data)
               });
           ...
           <div class="modal-dialog" style="max-width: 70rem" role="document">
             <div class="modal-content">
               <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabel1"> <?php echo $lang['General_Ledger'];?></h5>
                       ...
                       <tbody class="myTable">
                         ...
                         <tr class="a" tx="tx" de="de" ce="ce" del="del">
                           ...
                           <td>
                             ...
                             <select name="from[]" class="ex form-select ">
                           ...
                           <td style="padding: .625rem 0.25rem;">
                             <center><button type="button" style="float:left;" class="del del0 btn btn-danger" de="" ce="" a="a"><i class="bx bxs-trash-alt"></i></button><button style="float:right;" type="button" onclick="add(1,0)" de="0" ce="0" class="cost cost0  btn btn-success"><i class='bx bxs-add-to-queue'></i></button></center>
                           </td>
         ...
         <script type="text/javascript">
           ...
           $(document).ready(function() {
             $(".ar").attr("href", "inc/des/lang.php?lang=ar&page='manger2=list'");
             $(".en").attr("href", "inc/des/lang.php?lang=en&page='manger2=list'");
           });
         </script>