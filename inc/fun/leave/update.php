...
$emp_depart=$row['depart'];
	...
	$sql->update('emp_leave',$id,["emp_name"=>"$emp_name","emp_id"=>"$emp_id","emp_depart"=>"$emp_depart","leave_type"=>"$leave_type","from_date"=>"$from_date","to_date"=>"$to_date","stat"=>1,"des"=>"$des","days"=>"$days"]);
