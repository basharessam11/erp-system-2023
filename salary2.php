                 ...
                 <table width="10%" class="datatables-basic  table table-bordered">
                   <thead>
                     <tr>
                       ...
                       <th style="padding: .625rem 0.25rem;">
                         <center><?php echo $lang['installment_amount'];?> </center>
                       </th>
                       <th style="padding: .625rem 0.25rem;">
                         <center><?php echo $lang['AMOUNT'];?></center>
                       </th>
                       <th style="padding: .625rem 0.25rem;">
                         <center><?php echo $lang['Residual'];?></center>
                       </th>
...
if (isset($_GET['search'])) {
  ...
  $sql->selectall("salary2 where  name LIKE '$search%'   limit 10 offset  $id");
  }else{
  ...
  for ($i=1; $i <=$page ; $i++) { 
   $id=$id+10;
    ...
    $sql->selectall("salary2 ORDER BY id desc limit 10 offset  $id ");
  }
      ...
      ?>
                     <tr>
                       ...
                       <td style="padding: .625rem 0.25rem;">
                         <center><?php
      $user=$row['emp_id'];
      $sql->select1("emp_profile","where id = $user");
...
echo$row1['name'];
                       ...
                       <td style="padding: .625rem 0.25rem;">
                         <center><?=$row["p_price"]?></center>
                       </td>

                       <td style="padding: .625rem 0.25rem;">
                         <center>

                           <a href="?salary2=edit&id=<?=$row['id']?>">
    ...
    if (isset($_GET['search'])) {
              $search=$_GET['search'];
              $sql->selectall("salary2  where  name LIKE '$search%' ");
              $num=$sql->res->num_rows;
              $n=ceil($num/10+1);
    }else{
      $sql->check('salary2',["1"=>1]);
       $n=ceil($sql->check/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             if($page!=1){
              if (isset($_GET['search'])) {
                 echo '<li class="page-item "><a class="page-link" href="?salary2=list&search='.$search.'&page='.$pp.'" tabindex="">Previous</a></li>';
              }else{
                 echo '<li class="page-item "><a class="page-link" href="?salary2=list&page='.$pp.'" tabindex="">Previous</a></li>';
              }
              ...
              if ($get<0) {
               $get=1;
                    ...
                    if ($_GET['page']==$i) {
                     ...
                     if (isset($_GET['search'])) {
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary2=list&search='.$search.'&page='.$i.'">'.$i.'</a></li>';
              }else{
                echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary2=list&page='.$i.'">'.$i.'</a></li>';              }
              ...
              for ($i=$_GET['page']; $i <$n ; $i++ ) { 
                  ...
                  if ($i<=$_GET['page']+5) {
                    ...
                    if (isset($_GET['search'])) {
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary2=list&search='.$_GET['search'].'&page='.$i.'">'.$i.'</a></li>';
                    }else{
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?salary2=list&page='.$i.'">'.$i.'</a></li>';
                    }
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                  if (isset($_GET['search'])) {
                    echo '<a class="page-link" href="?salary2=list&search='.$_GET['search'].'&page='.$page.'">Next</a>';
                  }else{
                    echo '<a class="page-link" href="?salary2=list&page='.$page.'">Next</a>';
                  }
         ...
         <script type="text/javascript" class="init">
           $(document).ready(function() {
             $("#myInput").on("keyup", function() {
               ...
               $.post('inc/fun/salary2/select.php', {
                 search: value
               }, function(data) {
                 $(".kk").html(data)
               });
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/salary2/delete.php">
         ...
         <script>
           ...
           $(document).ready(function() {
             $(".ar").attr("href", "inc/des/lang.php?lang=ar&page='salary2=list'");
             $(".en").attr("href", "inc/des/lang.php?lang=en&page='salary2=list'");
           });
         </script>