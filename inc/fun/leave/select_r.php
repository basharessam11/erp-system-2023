...
<table width="100%"  class="datatables-basic table table-bordered ">
  ...
  $sql->selectall("emp_leave where stat=3 and  emp_name LIKE '$search%'  ORDER BY id DESC  limit 10 offset  $id");
  ...
  echo '<div class="alert alert-warning">Waiting for manager approval<div>';
    ...
    echo '<div class="alert alert-success">Been approved<div>';
      ...
      ?> </center></td>
          ...
          <a href="inc/fun/leave/stat.php?id=<?=$row["id"]?>&stat=4">
...
<?php
        ...
        $sql->selectall("emp_leave  where  stat=3 and emp_name LIKE '$search%' ");
   ...
   $n=ceil($num/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             $pp=$page-1;
             if($page!=1){
                  echo '<li class="page-item "><a class="page-link" href="?leave_resume=list&page='.$pp.'" tabindex="">Previous</a></li>';
                }else{
              ...
              if ($get<0) {
               $get=1;
                  ...
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?leave_resume=list&search='.$search.'&page='.$i.'">'.$i.'</a></li>';
                }
                          } 
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                echo '<a class="page-link" href="?leave_resume=list&page='.$page.'">Next</a>';
              }else{
                echo '<li class="page-item disabled">
...
<?php
  ...
  $sql->selectall("emp_leave where stat=3 ORDER BY id DESC limit 10   offset  $id ");
             ...
             if($page!=1){
              ...
              if ($get<0) {
               $get=1;
                  ...
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?leave_resume=list&page='.$i.'">'.$i.'</a></li>';
                }
                          } 
