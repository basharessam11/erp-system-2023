           ...
           <div class="row g-4 mb-4">
             ...
             <div class="card">
               <div class="row ">
                 ...
                 <div class="card-header border-bottom col-sm-12 col-md-12">
                   <h5 class="card-title" style="float:left;">qu</h5>
 ...
 <center>هذا الاسم موجود بالفعل</center>
</div>';
          }
               ...
               <div class="row">
                 ...
                 <div class="col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end">
                   <div id="DataTables_Table_1_filter" class="dataTables_filter">
                     <br>
                     <a href="?qu=add"> <button type="button" class=" btn btn-success" data-bs-toggle="modal" data-bs-target="#basicModal1">
                         <?php echo $lang['Add'];?>
                       </button></a>
                     <br><br>
...
if (isset($_GET['search'])) {
  ...
  $sql->selectall("qu where  name LIKE '$search%'   limit 10 offset  $id");
  }else{
  ...
  for ($i=1; $i <=$page ; $i++) { 
   $id=$id+10;
    ...
    $sql->selectall("qu ORDER BY id desc limit 10 offset  $id ");
  }
...
?></center>
    ...
    if (isset($_GET['search'])) {
              $search=$_GET['search'];
              $sql->selectall("qu  where  name LIKE '$search%' ");
      ...
      $sql->check('qu',["1"=>1]);
       $n=ceil($sql->check/10+1) ;
            ...
            $page=$_GET['page']=1;
             ...
             if($page!=1){
              if (isset($_GET['search'])) {
                 echo '<li class="page-item "><a class="page-link" href="?qu=list&search='.$search.'&page='.$pp.'" tabindex="">Previous</a></li>';
              }else{
                 echo '<li class="page-item "><a class="page-link" href="?qu=list&page='.$pp.'" tabindex="">Previous</a></li>';
              }
              ...
              if ($get<0) {
               $get=1;
                    ...
                    if ($_GET['page']==$i) {
                     ...
                     if (isset($_GET['search'])) {
                  echo'<li class="page-item '.$a.'"><a class="page-link" href="?qu=list&search='.$search.'&page='.$i.'">'.$i.'</a></li>';
              }else{
                echo'<li class="page-item '.$a.'"><a class="page-link" href="?qu=list&page='.$i.'">'.$i.'</a></li>';              }
              ...
              for ($i=$_GET['page']; $i <$n ; $i++ ) { 
                  ...
                  if ($i<=$_GET['page']+5) {
                    ...
                    if (isset($_GET['search'])) {
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?qu=list&search='.$_GET['search'].'&page='.$i.'">'.$i.'</a></li>';
                    }else{
                      echo'<li class="page-item '.$a.'"><a class="page-link" href="?qu=list&page='.$i.'">'.$i.'</a></li>';
                    }
              ...
              if ($hi>1) {
                 if ($page!=$i) {
                  if (isset($_GET['search'])) {
                    echo '<a class="page-link" href="?qu=list&search='.$_GET['search'].'&page='.$page.'">Next</a>';
                  }else{
                    echo '<a class="page-link" href="?qu=list&page='.$page.'">Next</a>';
                  }
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 <div class="row">
                   <form method="post" action="inc/fun/qu/delete.php">
         ...
         <script>
           ...
           $(document).ready(function() {
             $(".ar").attr("href", "inc/des/lang.php?lang=ar&page='qu=list'");
             $(".en").attr("href", "inc/des/lang.php?lang=en&page='qu=list'");
           });
         </script>