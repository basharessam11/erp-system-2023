   <div class="container-xxl flex-grow-1 container-p-y">
     <div class="row g-4 mb-4">
       ...
       <div class="card">
         ...
         <br><br><br>
         <div class="kk">
           <form method="post" action="inc/fun/emp_profile/insert_q.php">
  ...
  $emp_id=$_GET['id'];
      $sql->selectall("qu where emp_id=$emp_id ORDER BY name   ");
     ...
     while ($row = $sql->res->fetch_assoc()) {
      ...
      ?>
                 <tr>
                   ...
                   <td style="padding: .625rem 0.25rem;">
                     <center><?=$row["name"]?><input type="hidden" value="<?=$row["id"]?>" name="qu[]"><input type="hidden" value="<?=$row["waith"]?>" name="wa[]"></center>
                   </td>
                   <td style="padding: .625rem 0.25rem;">
                     <center><input class="qu" onchange="qu()" value="<?=1*$row["waith"]/100?>" checked="" type="radio" name="a<?=$x1?>"></center>
                   </td>
                   <td style="padding: .625rem 0.25rem;">
                     <center><input class="qu" onchange="qu()" value="<?=2*$row["waith"]/100?>" type="radio" name="a<?=$x1?>"></center>
                   </td>
                   <td style="padding: .625rem 0.25rem;">
                     <center><input class="qu" onchange="qu()" value="<?=3*$row["waith"]/100?>" type="radio" name="a<?=$x1?>"></center>
                   </td>
                   <td style="padding: .625rem 0.25rem;">
                     <center><input class="qu" onchange="qu()" value="<?=4*$row["waith"]/100?>" type="radio" name="a<?=$x1?>"></center>
                   </td>
                   <td style="padding: .625rem 0.25rem;">
                     <center><input class="qu" onchange="qu()" value="<?=5*$row["waith"]/100?>" type="radio" name="a<?=$x1?>"></center>
                   </td>
