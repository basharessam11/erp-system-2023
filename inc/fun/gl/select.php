...
<table width="100%"  class="datatables-basic table table-bordered ">
  ...
  $sql->selectall("trans where t_type=1 and name LIKE '%$search%'  ORDER BY id DESC limit 10 offset  $id");
...
<?php
        ...
        $sql->selectall("trans  where t_type=1 and  name LIKE '$search%' ");
...
<?php
  ...
  <table width="100%"  class="datatables-basic table table-bordered ">
      <thead>
         <tr>
          ...
          <th style="padding: .625rem 0.25rem;"><center>#</center></th>
          <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['DESCRIPTION'];?></center> </th>
           <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['Ref'];?></center> </th>
           <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['Currency'];?></center> </th>
           <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['Date'];?></center> </th>
		  <th style="padding: .625rem 0.25rem;"><center><?php echo $lang['attach'];?></center> </th>
  ...
  $sql->selectall("trans where t_type=1 ORDER BY id DESC limit 10   offset  $id ");
